# Bootstrappable Halal Core Builds

This directory contains the files necessary to perform bootstrappable Halal
Core builds.
...
To build Halal Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Halal Core version being built.
