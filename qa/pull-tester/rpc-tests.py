...
#Set env vars
if "HALALD" not in os.environ:
    os.environ["HALALD"] = BUILDDIR + '/src/halald' + EXEEXT
if "HALALCLI" not in os.environ:
    os.environ["HALALCLI"] = BUILDDIR + '/src/halal-cli' + EXEEXT
