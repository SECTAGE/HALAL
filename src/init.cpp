...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/SECTAGE/HALAL>";
    const std::string URL_WEBSITE = "<https://halal-coin.com/>";
    ...
    return  strprintf("Copyright (C) %i The Halal Core developers", COPYRIGHT_YEAR) + "\n" + 
            strprintf("Copyright (C) %i-%i The Firo Core developers", 2016, COPYRIGHT_YEAR) + "\n" + 
            strprintf("Copyright (C) %i-%i The Bitcoin Core developers", 2016, COPYRIGHT_YEAR) + "\n" + 
           "\n" +
