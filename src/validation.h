...
/** btzc: update Halal config */
/** Default for DEFAULT_WHITELISTRELAY. */
static const bool DEFAULT_WHITELISTRELAY = true;
/** Default for DEFAULT_WHITELISTFORCERELAY. */
static const bool DEFAULT_WHITELISTFORCERELAY = true;
/** Default for -minrelaytxfee, minimum relay fee for transactions */
//btzc: update Halal fee
static const unsigned int DEFAULT_MIN_RELAY_TX_FEE = CENT / 1000; //0.00001 halal,
...
/** The pre-allocation chunk size for blk?????.dat files (since 0.8), btzc:halal: 16MiB */
static const unsigned int BLOCKFILE_CHUNK_SIZE = 0x1000000; // 16 MiB
/** The pre-allocation chunk size for rev?????.dat files (since 0.8), btzc:halal: 1MiB */
...
bool AcceptToMemoryPool(CTxMemPool& pool, CValidationState &state, const CTransactionRef &tx, bool fLimitFree,
                        ...
                        bool fOverrideMempoolLimit=false, const CAmount nAbsurdFee=0, bool isCheckWalletTransaction=false, bool markHalalSpendTransactionSerial=true);
