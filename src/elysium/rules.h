#ifndef HALAL_ELYSIUM_RULES_H
#define HALAL_ELYSIUM_RULES_H
...
public:
    ...
    /**
     * Amount of HALAL to pay when create a new property on main ecosystem.
     **/
