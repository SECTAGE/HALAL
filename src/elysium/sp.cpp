...
CMPSPInfo::CMPSPInfo(const boost::filesystem::path& path, bool fWipe)
{
    ...
    implied_elysium.url = "https://www.halal.org";
    implied_elysium.data = "Exodus serve as the binding between Halal, smart properties and contracts created on the Exodus Layer.";
    ...
    implied_telysium.url = "https://www.halal.org";
    implied_telysium.data = "Test Exodus serve as the binding between Halal, smart properties and contracts created on the Exodus Layer.";
        ...
        std::pair<int64_t, int64_t>& tokens, bool& close_crowdsale)
{
    ...
    // Precision for all non-halal values (bonus percentages, for example)
    ...
    // Precision for halal amounts (satoshi)
