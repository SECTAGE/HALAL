#ifndef HALAL_PARAMS_H
#define HALAL_PARAMS_H
...
//static const int64_t DUST_SOFT_LIMIT = 100000; // 0.001 HALAL
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64_t DUST_HARD_LIMIT = 1000;   // 0.00001 HALAL mininput

// There were bugs before this block, don't do some checks on early blocks
#define ZC_CHECK_BUG_FIXED_AT_BLOCK         120 //61168 DISCARD

// Before this block we allowed not paying to the znodes.
#define ZC_ZNODE_PAYMENT_BUG_FIXED_AT_BLOCK         1 //107246 DISCARD

// Do strict check on duplicate minted public coin value after this block
#define ZC_CHECK_DUPLICATE_MINT_AT_BLOCK    70000 // DISCARD
...
#define ZC_V1_5_STARTING_BLOCK          1 //78500 DISCARD
#define ZC_V1_5_TESTNET_STARTING_BLOCK  37954

#define ZC_V1_5_GRACEFUL_MEMPOOL_PERIOD	500 // DISCARD
#define ZC_V1_5_GRACEFUL_PERIOD			1500 // DISCARD

// Block after which sigma mints are activated.
#define ZC_SIGMA_STARTING_BLOCK         100 //184200 //Approx July 30th, 2019, 8:00 AM UTC
#define ZC_SIGMA_TESTNET_STARTING_BLOCK 50000

// Block after which anonymity sets are being padded.
#define ZC_SIGMA_PADDING_BLOCK         1 //220720 //Approx December 5th 12PM UTC
#define ZC_SIGMA_TESTNET_PADDING_BLOCK 110000

//Block after whinch we are disabling sigma to enable after starting padding
#define ZC_SIGMA_DISABLE_UNPADDED_BLOCK         1 //219904 //December 2nd 12PM UTC
#define ZC_SIGMA_TESTNET_DISABLE_UNPADDED_BLOCK 109160

// The block number after which old sigma clients are banned.
#define ZC_OLD_SIGMA_BAN_BLOCK          1 //181850 //Approx July 22nd, 2019, 4:00 AM UTC

// Block after which lelantus mints are activated.
#define ZC_LELANTUS_STARTING_BLOCK         1 //336888
#define ZC_LELANTUS_FIXES_START_BLOCK      150 //365544 //Approx April 22, 20211, 2:00 PM UTC
...
#define ZC_V2_MINT_GRACEFUL_MEMPOOL_PERIOD          1 //4500
...
#define ZC_V2_MINT_GRACEFUL_PERIOD          1 //5000
...
#define ZC_V2_SPEND_GRACEFUL_MEMPOOL_PERIOD         1 //9000
...
#define ZC_V2_SPEND_GRACEFUL_PERIOD         1 //10000
#define ZC_V2_SPEND_TESTNET_GRACEFUL_PERIOD 2000

#define ZC_MODULUS_V2_START_BLOCK		130 //89300
#define ZC_MODULUS_V1_MEMPOOL_STOP_BLOCK        135 //89500
#define ZC_MODULUS_V1_STOP_BLOCK		140 //89800
...
#define ZC_MULTIPLE_SPEND_INPUT_STARTING_BLOCK  1 //119000
...
#define ZC_GENESIS_BLOCK_TIME 1656478800 //Wednesday, June 29, 2022 5:00:00 AM

#define SWITCH_TO_MTP_BLOCK_HEADER 1657694760 // Wednesday, July 13, 2022 6:46:00 AM
#define SWITCH_TO_MTP_5MIN_BLOCK 21
