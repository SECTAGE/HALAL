#ifndef HALAL_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
#define HALAL_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
...
#endif //HALAL_LIBLELANTUS_INNER_PRODUCT_PROOF_VERIFIER_H
