...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s halal-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  halal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Halal transaction") + "\n" +
              "  halal-tx [options] -create [commands]   " + _("Create hex-encoded Halal transaction") + "\n" +
              "\n";
