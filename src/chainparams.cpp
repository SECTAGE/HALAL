...
static Consensus::LLMQParams llmq50_60 = {
        ...
        .dkgInterval = 45, // one DKG per 90 minutes
        .dkgPhaseBlocks = 2,
...
static Consensus::LLMQParams llmq400_60 = {
        ...
        .dkgInterval = 360, // one DKG every 12 hours
        .dkgPhaseBlocks = 4,
...
static Consensus::LLMQParams llmq400_85 = {
        ...
        .dkgInterval = 720, // one DKG every 24 hours
        .dkgPhaseBlocks = 4,
        .dkgMiningWindowStart = 50, // dkgPhaseBlocks * 5 = after finalization
...
public:
    CMainParams()
    {
        ...
        consensus.nSubsidyHalvingFirst = 0;
        consensus.nSubsidyHalvingInterval = 460000;
        consensus.nSubsidyHalvingStopBlock = 99999999;

        consensus.stage2DevelopmentFundShare = 5;
        consensus.stage2ZnodeShare = 15;
        consensus.stage2DevelopmentFundAddress = "HhDUUKxRetK8ijcrqXwdoFQiwvDSisTDuq";
        ...
        consensus.DIP0003EnforcementHeight = 150; // Approximately July 13 2020, 12:00 UTC
        ...
        consensus.DIP0008Height = 150; // Approximately Jan 28 2021, 11:00 UTC
        ...
        consensus.nInstantSendBlockFilteringStartHeight = 800; // Approx Nov 2 2021 06:00:00 GMT+0000

        consensus.nMTPSwitchTime = SWITCH_TO_MTP_BLOCK_HEADER;
        consensus.nMTPStartBlock = 16;
        consensus.nMTPFiveMinutesStartBlock = SWITCH_TO_MTP_5MIN_BLOCK;
        consensus.nMTPStripDataTime = INT_MAX; // December 08, 2021 09:00 UTC

        consensus.nDifficultyAdjustStartBlock = 100;
        consensus.nFixedDifficulty = 0x1f1bc330;
        consensus.nPowTargetSpacingMTP = 1 * 60;
        consensus.nInitialMTPDifficulty = 0x1f1bc330;
       ...
       `  * a large 32-bit integer with any alignment.
        ...
        genesis = CreateGenesisBlock(ZC_GENESIS_BLOCK_TIME, 107803, 0x1e0ffff0, 2, 0 * COIN, extraNonce);
        const std::string s = genesis.GetHash().ToString();
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x15217be194042561c0dc5374995ca4b3c0cfb11cce3c6ff743b765dd0987b1f9"));
        assert(genesis.hashMerkleRoot == uint256S("0x365d2aa75d061370c9aefdabac3985716b1e3b4bb7c4af4ed54f25e5aaa42783"));

        vSeeds.push_back(CDNSSeedData("139.180.202.170", "139.180.202.170", false));
        vSeeds.push_back(CDNSSeedData("2401:c080:1000:4e01:5400:04ff:fe0f:8539", "2401:c080:1000:4e01:5400:04ff:fe0f:8539", false));
        vSeeds.push_back(CDNSSeedData("45.32.45.33", "45.32.45.33", false));
        vSeeds.push_back(CDNSSeedData("2001:19f0:7001:47a5:5400:04ff:fe0f:853a", "2001:19f0:7001:47a5:5400:04ff:fe0f:853a", false));
        vSeeds.push_back(CDNSSeedData("80.240.31.80", "80.240.31.80", false));
        vSeeds.push_back(CDNSSeedData("2a05:f480:1800:207:5400:04ff:fe0f:84ab", "2a05:f480:1800:207:5400:04ff:fe0f:84ab", false));
        vSeeds.push_back(CDNSSeedData("45.77.54.43", "45.77.54.43", false));
        vSeeds.push_back(CDNSSeedData("2a05:f480:1800:874:5400:04ff:fe0f:84ac", "2a05:f480:1800:874:5400:04ff:fe0f:84ac", false));
        vSeeds.push_back(CDNSSeedData("80.240.17.133", "80.240.17.133", false));
        vSeeds.push_back(CDNSSeedData("2001:19f0:6c01:1968:5400:04ff:fe0f:84ad", "2001:19f0:6c01:1968:5400:04ff:fe0f:84ad", false));
        vSeeds.push_back(CDNSSeedData("136.244.82.213", "136.244.82.213", false));
        vSeeds.push_back(CDNSSeedData("2a05:f480:1800:f5d:5400:04ff:fe0f:84ae", "2a05:f480:1800:f5d:5400:04ff:fe0f:84ae", false));
        vSeeds.push_back(CDNSSeedData("136.244.82.108", "136.244.82.108", false));
        vSeeds.push_back(CDNSSeedData("2001:19f0:6c01:1931:5400:04ff:fe0f:84af", "2001:19f0:6c01:1931:5400:04ff:fe0f:84af", false));
        vSeeds.push_back(CDNSSeedData("136.244.87.189", "136.244.87.189", false));
        vSeeds.push_back(CDNSSeedData("2001:19f0:6c01:1fe1:5400:04ff:fe0f:84b0", "2001:19f0:6c01:1fe1:5400:04ff:fe0f:84b0", false));
        vSeeds.push_back(CDNSSeedData("136.244.89.85", "136.244.89.85", false));
        vSeeds.push_back(CDNSSeedData("2001:19f0:6c01:1ce4:5400:04ff:fe0f:84b1", "2001:19f0:6c01:1ce4:5400:04ff:fe0f:84b1", false));
        ...
        checkpointData = (CCheckpointData){
			...
			(0, uint256S("0x15217be194042561c0dc5374995ca4b3c0cfb11cce3c6ff743b765dd0987b1f9"))
			(1, uint256S("0x1c0dd1193a136ecc8e53faac2f6f55324e200855b5f9492c67e2813976e8259e"))
			(754, uint256S("0x079d62da4023214e6456ae4f4c155fff1f1471ddadd92787d812e3207c81150c"))
			(1646, uint256S("0x9fa3734739591f2017de63a064868914fd6d8b8fabdf0fa66f7c4cb5a326c631"))
			(2964, uint256S("0x3fffd0a0a5601b4db274c49e95eb489d3116296ebd90a2b26ed6b6ab393f5995"))
			(3431, uint256S("0x1b5c6bccc8192b1b7410630857b04fd0c8ba9a2dd2601dcb54f97eae37249429"))
			(4333, uint256S("0xbd32697041e79e937fbfdd62eca771541c8ad61aceaf5e3cde7e0c274cf8c671"))
			};

        chainTxData = ChainTxData{
            1657876924, // * UNIX timestamp of last checkpoint block
            6509,          // * total number of transactions between genesis and last checkpoint
        ...
        consensus.evoSporkKeyID = "HXwitPEG83HQA4Auxr1PZg5QThdPAXbdXX";
        consensus.nEvoSporkStartBlock = ZC_LELANTUS_STARTING_BLOCK;
        consensus.nEvoSporkStopBlock = ZC_LELANTUS_STARTING_BLOCK + 4 * 24 * 12 * 365; // two years after lelantus
        consensus.nEvoSporkStopBlockExtensionVersion = 1000000;
        ...
        // ProgPow
        consensus.nPPSwitchTime = 1657695120; // Wednesday, July 13, 2022 6:52:00 AM
        consensus.nPPBlockNumber = 21;
        consensus.nInitialPPDifficulty = 0x1e0ffff0; // 40GH/s
    }
    virtual bool SkipUndoForBlock(int nHeight) const
    {
        return nHeight == INT_MAX;
    }
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0xaa22adcc12becaf436027ffe62a8fb21b234c58c23865291e5dc52cf53f64fca"));
        //assert(genesis.hashMerkleRoot == uint256S("0xf70dba2d976778b985de7b5503ede884988d78fbb998d6969e4f676b40b9a741"));
        vFixedSeeds.clear();
        vSeeds.clear();
        // halal test seeds

        vSeeds.push_back(CDNSSeedData("EVO1", "evo1.halal.org", false));
        vSeeds.push_back(CDNSSeedData("EVO2", "evo2.halal.org", false));
...
public:
    CDevNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x1fcfe26873831662874b5358c4a28611be641fbb997e62d8bf9c80f799f5caff"));
        //assert(genesis.hashMerkleRoot == uint256S("0x3a0d54ae5549a8d75cd8d0cb73c6e3577ae6be8d5706fc9411bdebbe75c97210"));
        vFixedSeeds.clear();
        vSeeds.clear();
        // halal test seeds

        vSeeds.push_back(CDNSSeedData("DEVNET1", "devnet1.halal.org", false));
        vSeeds.push_back(CDNSSeedData("DEVNET2", "devnet2.halal.org", false));
