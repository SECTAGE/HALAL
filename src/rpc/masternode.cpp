...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the znode owner Halal address\n"
            "  payee          - Print the znode payout Halal address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the znode operator public key\n"
            "  status         - Print znode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the znode voting Halal address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "halal",               "znode",                 &masternode,             true,  {} },
    { "halal",               "znodelist",             &masternodelist,         true,  {} },
    { "halal",               "evoznode",              &masternode,             true,  {} },
    { "halal",               "evoznodelist",          &masternodelist,         true,  {} },
};
